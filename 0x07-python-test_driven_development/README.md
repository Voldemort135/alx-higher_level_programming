...
Test passed.
guillaume@ubuntu:~/0x07$ python3 -c 'print(**import**("0-add_integer").**doc**)' | wc -l
5
guillaume@ubuntu:~/0x07$ python3 -c 'print(**import**("0-add_integer").add_integer.**doc**)' | wc -l
3
...
#!/usr/bin/python3
matrix_divided = **import**('2-matrix_divided').matrix_divided
...
#!/usr/bin/python3
say_my_name = **import**('3-say_my_name').say_my_name
...
#!/usr/bin/python3
print_square = **import**('4-print_square').print_square
...
#!/usr/bin/python3
text_indentation = **import**('5-text_indentation').text_indentation
